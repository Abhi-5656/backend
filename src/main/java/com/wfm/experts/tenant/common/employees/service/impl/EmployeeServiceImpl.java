...
//        }
//
//        String employeeName = newEmployee.getPersonalInfo() != null ? newEmployee.getPersonalInfo().getFullName() : newEmployee.getEmail();
//        String companyName = environment.getProperty("spring.application.name", "Your Company Name"); // Fallback to application name
//
//        try {
//            // Determine Login URL (base URL + tenantId)
//            String hostAddress = environment.getProperty("server.address", "localhost");
//            String port = environment.getProperty("server.port", "8080");
//            // The full login URL in your system appears to be http://[host]:[port]/[tenantId]/api/auth/login, but the UI link is just to the tenant's base URL.
//            String loginUrl = String.format("http://%s:%s/%s/login", hostAddress, port, tenantId);
//
