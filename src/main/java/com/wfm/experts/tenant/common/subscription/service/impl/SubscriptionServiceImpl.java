package com.wfm.experts.tenant.common.subscription.service.impl;
...
//import java.util.logging.Logger;
//
//// Exceptions (your package)
//import com.wfm.experts.tenant.common.subscription.exception.DuplicateSubscriptionException;
//import com.wfm.experts.tenant.common.subscription.exception.InvalidGstException;
//import com.wfm.experts.tenant.common.subscription.exception.TenantProvisioningException;
//
//// Mapper
//import com.wfm.experts.tenant.common.subscription.mapper.SubscriptionMapper;
//
//@Service
//public class SubscriptionServiceImpl implements SubscriptionService {
//
...
//        if (subscriptionRepository.existsByAdminEmail(email)) {
//            throw new DuplicateSubscriptionException("Admin email already exists: " + email);
//        }
//
//
//        if (subscriptionRepository.existsByAdminEmail(email)) {
...
//        // === Validation & checks ===
//        if (!isValidGstNumber(subscription.getCompanyGstNumber())) {
//            throw new InvalidGstException("Invalid GST Number format.");
//        }
//
//        String tenantId = TenantIdUtil.generateTenantId(subscription.getCompanyName());
//        if (subscriptionRepository.existsByTenantId(tenantId)) {
//            throw new DuplicateSubscriptionException(
//                    "Tenant ID already exists: " + tenantId + ". Company name might be too similar to an existing one.");
//        }
//
//        Map<String, Object> tenantData = tenantService.createTenantSchema(subscription.getCompanyName());
//        if (tenantData == null || !tenantData.containsKey("tenantSchema")) {
//            throw new TenantProvisioningException("Error: Tenant schema creation failed.");
//        }
//        String tenantSchemaName = (String) tenantData.get("tenantSchema");
//
//        String tenantURL = generateTenantURL(tenantId);
...
//        LOGGER.log(Level.INFO, "Subscription saved for tenant ID: {0}", tenantId);
//
//        //Existing duplicate tenant check (kept)
//        if (subscriptionRepository.existsByTenantId(tenantId)) {
//            throw new DuplicateSubscriptionException(
//                    "Tenant ID already exists: " + tenantId + ". Company name might be too similar to an existing one.");
//        }
//        // SubscriptionServiceImpl.createSubscription(...)
//        if (subscription.getCompanyGstNumber() != null
//                && subscriptionRepository.existsByCompanyGstNumber(subscription.getCompanyGstNumber())) {
//            throw new DuplicateSubscriptionException(
//                    "GST number already exists: " + subscription.getCompanyGstNumber());
//        }
//        // NEW: pre-check admin email uniqueness to avoid DB 23505
//        if (subscriptionRepository.existsByAdminEmail(email)) {
//            throw new DuplicateSubscriptionException("Admin email already exists: " + email);
//        }
//        // Admin bootstrap (same as before)
//        createAdminEmployeeInTenant(tenantId, firstName, lastName, email, employeeId, phoneNumber);
//
...
//            System.out.println("Tenant ID: " + tenantId);
//            System.out.println("Username (Email): " + email);
//            System.out.println("Generated Raw Password: " + rawPassword);
//            System.out.println("Employee ID: " + employeeId);
//            System.out.println("--------------------------------------------------------------------------");
//
//        } catch (Exception e) {
//            LOGGER.log(Level.SEVERE, "Error saving admin employee for tenant " + tenantId, e);
//            throw new TenantProvisioningException("Failed to create admin employee for tenant " + tenantId, e);
//        } finally {
//            TenantContext.clear();
//        }
//    }
