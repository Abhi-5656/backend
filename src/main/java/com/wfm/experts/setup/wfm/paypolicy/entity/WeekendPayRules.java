...
//
//        int weekendWorkMinutes = workedMinutes;
...
//                shiftDuration += 1440;
//            }
//            weekendWorkMinutes = Math.min(workedMinutes, (int) shiftDuration);
//        }
//
//        context.getFacts().put("weekendWorkedMinutes", weekendWorkMinutes);
//
//        String message = "Weekend Pay Applied. " + weekendWorkMinutes + " minutes marked as weekend work.";
//
//        return PayPolicyRuleResultDTO.builder()
//                .ruleName(getName())
//                .result("WEEKEND_WORK")
...
public class WeekendPayRules implements PayPolicyRule {
    ...
    public PayPolicyRuleResultDTO execute(PayPolicyExecutionContext context) {
        ...
        context.getFacts().put("workedMinutes", workedMinutes - weekendWorkMinutes);
