...
public interface AppNotificationService {
    ...
    // [NEW METHOD] Marks a pending approval notification as read/cleared for the approver.
    int markPendingApprovalAsRead(Long approvalId, String userId);

    // [NEW METHOD] Explicitly updates the leaveStatus in the notification's additionalData payload for history.
    int updateLeaveStatusOfNotificationByApprovalId(Long approvalId, String userId, String newLeaveStatus);
